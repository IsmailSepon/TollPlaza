...
public class DelateActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        delatebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showprogessdialog("Deleting....");
               if (mCustomDate==null){
                   Toast.makeText(DelateActivity.this, "Please Select Date First..", Toast.LENGTH_SHORT).show();
               }else {
